      ...
      <div className="flex w-full flex-col gap-4 xl:w-1/3">
        <div className="rounded-md bg-white p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs text-gray-500">
            <Link className="bg-edunexusSkyLight rounded-md p-3" href={`/list/lessons?classId=2`}>
              Student&apos;s Lessons
            </Link>
            <Link
            ...
            <Link className="rounded-md bg-pink-50 p-3" href={`/list/exams?classId=${2}`}>
              Student&apos;s Exams
            </Link>
            <Link
              className="bg-edunexusSkyLight rounded-md p-3"
              href={`/list/assignments?classId=${2}`}
            >
              Student&apos;s Assignments
            </Link>
            <Link
              className="bg-edunexusYellowLight rounded-md p-3"
