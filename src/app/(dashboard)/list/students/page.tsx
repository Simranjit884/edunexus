      ...
      <td>
        <div className="flex items-center gap-2">
          <Link href={`/list/students/${item.id}`}>
            <button className="bg-edunexusSky flex h-7 w-7 items-center justify-center rounded-full">
              <Image src="/view.png" alt="" width={16} height={16} />
            </button>
          </Link>
          {role === "admin" && (
            // <button className="w-7 h-7 flex items-center justify-center rounded-full bg-edunexusPurple">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex w-full flex-col items-center gap-4 md:w-auto md:flex-row">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {role === "admin" && (
              // <button className="w-8 h-8 flex items-center justify-center rounded-full bg-edunexusYellow">
